  ...
  $("[data-autocomplete]").each(function (index, element) {
    ...
    $(element).autocomplete({
      ...
      select: function (event, ui) {
        ...
        //za duzine
          var dest_geoduzina = $(`[data-autocomplete-placeholder-geoduzina='${resultplaceholder}']`);
          if (dest_geoduzina !== undefined) {
              $(dest_geoduzina).val(ui.item.geoduzina);
          }

          var dest_geosirina = $(`[data-autocomplete-placeholder-geosirina='${resultplaceholder}']`);
          if (dest_geosirina !== undefined) {
              $(dest_geosirina).val(ui.item.geosirina);
          }
